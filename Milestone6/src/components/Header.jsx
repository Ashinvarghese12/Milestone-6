...
const Header = () => {
  ...
  return (
    <div className="text-right px-5 pt-1 sticky top-0 z-10 bg-gray-100 flex justify-between">
      <div className="uppercase text-4xl font-semibold font-serif py-5">shopppiee</div>
